...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mapping_param', full_name='caffe.LayerParameter.mapping_param', index=58,
...
_MAPPINGPARAMETER = _descriptor.Descriptor(
  name='MappingParameter',
  full_name='caffe.MappingParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lr', full_name='caffe.MappingParameter.lr', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['mapping_param'].message_type = _MAPPINGPARAMETER
...
DESCRIPTOR.message_types_by_name['MappingParameter'] = _MAPPINGPARAMETER
...
MappingParameter = _reflection.GeneratedProtocolMessageType('MappingParameter', (_message.Message,), dict(
  DESCRIPTOR = _MAPPINGPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MappingParameter)
  ))
_sym_db.RegisterMessage(MappingParameter)
